...
const Navbar = () => {
  ...
  (function () {
    ...
    function _loadJs(a) {
      ...
      d.src = a;
      var f;
      a = ((d.ownerDocument && d.ownerDocument.defaultView) || window)
        .document;
      (f = (a =
    ...
    new google.translate.TranslateElement(
      {
        pageLanguage: "vi",
        includedLanguages:
          "en,en-GB,,en-US,vi,ru,ko,ja,it,qa,es,hi,bn,fr,de,ar,tr,pt,zh,da,la",
  ...
  return (
    <nav className="px-8">
      ...
      <div className="logo flex items-center h-full">
        <img src={logo} className="w-20 md:full" alt="Logo Image" />
      ...
      <ul className={`${isOpen ? "nav-links open" : "nav-links"}`}>
        <li className={`${isFade ? "fade " : "nav-links"} active`}>
          <Link to="/">Home</Link>
        </li>
        ...
        <li className={`${isFade ? " fade" : "nav-links"}`}>
          <Link to="/appartments">Apartment</Link>
        </li>
